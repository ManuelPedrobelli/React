export default function Portfolio() {
    return (
       <div id="portfolio" className="flex flex-col items-center justify-center gap-16 p-6 mx-auto  gap-12">
           ...
           <div className="flex flex-col bg-white items-center justify-center gap-8"> 

            <div id="trivia" className="w-1/3 h-96 redondear fondoNav flex flex-col items-center justify-center gap-5 p-2 md:flex-row ">
            ...
            <div id="guitar-store" className="w-1/3 h-96 redondear fondoNav flex flex-col items-center justify-center gap-5 p-2 md:flex-row">
                <div className="flex flex-col items-center justify-center text-center gap-4">
