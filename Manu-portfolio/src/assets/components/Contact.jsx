    ...
    return (
        <div id="contact" className="flex flex-col items-center justify-center mt-4 mb-4 text-center p-5 bg-white w-3/4 mx-auto rounded-3xl">
            ...
            <div className="rounded-3xl p-3">
                <button className="flex items-center justify-between px-3 py-4 gap-4 text-xl font-bold bg-rgb-blue rounded-xl zoom text-white" onClick={handleContactButtonClick}>
                    Contact me
                    <img className="w-10 h-10" src="email.webp" alt="Email Icon" />
                </button>
            </div>
        </div>
    );
