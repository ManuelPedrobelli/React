export default function Contact() {
    ...
    return (
        <div id="contact" className="mt-4 flex color2 flex-col items-center justify-center text-center mb-12 p-5 mx-auto rounded-3xl">
            ...
            <div className="redondear2 flex flex-col items-center px-4">
                ...
                <img src="perfil.jpg" alt="software engineer" className="zoomImg md:w-96 md:h-60 p-4 lg:w-120 lg:h-80 p-2 rounded-full" /> 
