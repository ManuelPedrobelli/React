export default function Stack() {
    return (
        <div id="stack" className="relative flex flex-col redondear items-center justify-center mx-auto mt-4  px-8 py-0 md:p-8 ">
            <h2 className="text-6xl font-bold text-white w-1/4 redondear p-2 text-center">Tech Stack</h2>
            <div className="redondear p-2 flex flex-wrap items-center justify-evenly gap-8 sm:flex-row mt-6">
