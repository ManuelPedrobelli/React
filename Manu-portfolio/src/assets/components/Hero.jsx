...
export default function HeroComponent() {
    return (
        <div id="div-hero" className='h-screen md:h-160 text-white gap-4 lg:h-120 bg-top-left flex p-4 md:p-8 gap-4 md:gap-9 lg:p-20 md:flex-row  md:justify-center'>
            <div id="hero-content" className=" animate__animated animate__flash flex flex-row items-center justify-center md:text-left mb-4 md:mb-0 gap-4 p-12 redondear">
                <div id='hero-title' className=" flex flex-col  gap-2 ml-12 p-6 redondear">
                    <h1 className=" transition-transform transform hover:-translate-y-1 text-left text-4xl md:text-5xl lg:text-9xl font-bold">
                        Manuel Pedrobelli
                    </h1>
                    <p className="title text-left text-2xl md:text-3xl lg:text-4xl mb-6">
                        Desarrollador web
                    </p>
