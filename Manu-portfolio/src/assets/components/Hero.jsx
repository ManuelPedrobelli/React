export default function HeroComponent() {
    return (
        <div className='bg-[url("/11857.jpg")] h-screen md:h-160 gap-4 lg:h-120 w-full bg-cover bg-center  flex flex-col justify-center items-center p-4 md:p-8 gap-4 md:gap-9 lg:p-20 md:flex-row md:justify-center mt-16 md:mt-16'>
            <div className="flex flex-col items-center justify-center text-center md:text-left mb-4 md:mb-0 gap-4">
            ...
            <div className="flex items-center justify-center md:ml-5 mt-2 md:mt-0">
                <img src="giphy.gif" alt="software engineer" className="zoom w-60 h-40 md:w-80 md:h-40 lg:w-96 lg:h-72 rounded-full shadow-lg" />
            </div>
        </div>
    );
}
